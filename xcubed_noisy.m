...
for M=Mval % loop over M
    ...
    save(strcat('xcubed_noisy_fmincon1_data','M',num2str(M),'pb',num2str(p_b),'.mat'),'x_opt','y_opt','e_opt','d_opt','p_b','M','xmall','endist','dedist','exitm','xinitm','xrnall','xrninitall','enall');
end
end
